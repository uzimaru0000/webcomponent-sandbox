...
function (_HTMLElement) {
  ...
  function Ripple() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Ripple).call(this));
  ...
  _createClass(Ripple, [{
    ...
    value: function connectedCallback() {
      ...
      this.addEventListener("mousedown", function (e) {
        ...
        var effect = _this2.shadowRoot.getElementById("effect");

        effect.style.left = "".concat(x - _this2.size / 2, "px");
        effect.style.top = "".concat(y - _this2.size / 2, "px");
    ...
    key: "template",
    get: function get() {
      return lit_html_1.html(_templateObject(), this.css);
    }
  }, {
    key: "css",
    get: function get() {
      return lit_html_1.html(_templateObject2(), this.size, this.size, this.color);
    }
  }]);
...
},{"lit-html":"../node_modules/lit-html/lit-html.js"}],"ts/input_form.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_HTMLElement) {
  _inherits(InputForm, _HTMLElement);
  ...
  function InputForm() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(InputForm).call(this));
  ...
  _createClass(InputForm, [{
    ...
    value: function connectedCallback() {
      this.render();
      var input = this.shadowRoot.getElementById("form");
    ...
    key: "render",
    value: function render() {
      lit_html_1.render(lit_html_1.html(_templateObject(), this.css, this.template), this.shadowRoot);
    }
  }, {
    key: "template",
    get: function get() {
      return lit_html_1.html(_templateObject2(), this.type, this.placeholder);
    }
  }, {
    key: "css",
    get: function get() {
      return lit_html_1.html(_templateObject3(), this.color, this.color);
    }
  }]);
...
},{"lit-html":"../node_modules/lit-html/lit-html.js"}],"ts/toggle.ts":[function(require,module,exports) {
"use strict";
...
function (_HTMLElement) {
  ...
  function Toggle() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Toggle).call(this));
  ...
  _createClass(Toggle, [{
    ...
    get: function get() {
      ...
      return lit_html_1.html(_templateObject2(), this._value, function () {
        return _this2.dispatchEvent(new CustomEvent("change"));
      });
    }
  }, {
    key: "css",
    get: function get() {
      return lit_html_1.html(_templateObject3());
    }
  }]);
...
},{"lit-html":"../node_modules/lit-html/lit-html.js"}],"elm/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$ripple = elm$html$Html$node('ripple-effect');
var author$project$Main$xInput = elm$html$Html$node('x-input');
var author$project$Main$xToggle = elm$html$Html$node('x-toggle');
...
var author$project$Main$view = function (_n0) {
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'border', '1px solid #60B5CC')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('This is Elm.')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('ClickMe!')
									])),
								A2(author$project$Main$ripple, _List_Nil, _List_Nil)
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						A2(author$project$Main$xToggle, _List_Nil, _List_Nil)
					]))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"()","aliases":{},"unions":{}}})}});
...
var _default = {};
exports.default = _default;
        var $cf77d2 = exports.default || module.exports;
      
      if (typeof $cf77d2 === 'function') {
        $cf77d2 = $cf77d2.options;
      }
    
        /* template */
        Object.assign($cf77d2, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    _c("div", { staticClass: "border" }, [
      _c("div", [_vm._v("This is Vue.js")]),
      _vm._v(" "),
      _c("div", [
        _c(
          "button",
          { staticClass: "button" },
          [_c("span", [_vm._v("ClickMe!")]), _vm._v(" "), _c("ripple-effect")],
          1
        )
      ]),
      _vm._v(" "),
      _c(
        "div",
        [_c("x-input", { attrs: { type: "email", placeholder: "email" } })],
        1
      ),
      _vm._v(" "),
      _c(
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cf77d2', $cf77d2);
          } else {
            api.reload('$cf77d2', $cf77d2);
          }
        }
...
},{"_css_loader":"../node_modules/parcel/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
require("./ts/input_form");

require("./ts/toggle"); // @ts-ignore


var Main_elm_1 = require("./elm/Main.elm");

var vue_1 = __importDefault(require("vue")); // @ts-ignore


var App_vue_1 = __importDefault(require("./vue/App.vue"));
...
},{"./ts/ripple":"ts/ripple.ts","./ts/input_form":"ts/input_form.ts","./ts/toggle":"ts/toggle.ts","./elm/Main.elm":"elm/Main.elm","vue":"../node_modules/vue/dist/vue.runtime.esm.js","./vue/App.vue":"vue/App.vue"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
